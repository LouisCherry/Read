...
public class LibraryActivity extends TreeActivity<LibraryTree> implements MenuItem.OnMenuItemClickListener, View.OnCreateContextMenuListener, IBookCollection.Listener {
	...
	public void onCreate(Bundle icicle) {
		...
		mySelectedBook =
			SerializerUtil.deserializeBook(getIntent().getStringExtra(CoreReadActivity.BOOK_KEY));
	...
	protected void onListItemClick(ListView listView, View view, int position, long rowId) {
		...
		if (book != null) {
			CoreReadActivity.openBookActivity(LibraryActivity.this, book, null);
			//showBookInfo(book);
		} else {
			openTree(tree);
		}
	...
	private void showBookInfo(Book book) {
		OrientationUtil.startActivity(
			...
			new Intent(getApplicationContext(), BookInfoActivity.class)
				.putExtra(CoreReadActivity.BOOK_KEY, SerializerUtil.serialize(book))
		);
	}
	//
	// Search
