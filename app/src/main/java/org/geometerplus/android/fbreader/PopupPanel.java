...
public abstract class PopupPanel extends ZLApplication.PopupPanel {
	...
	public void setPanelInfo(CoreReadActivity activity, RelativeLayout root) {
		myActivity = activity;
		myRoot = root;
	}

	public abstract void createControlPanel(CoreReadActivity activity, RelativeLayout root);
}
